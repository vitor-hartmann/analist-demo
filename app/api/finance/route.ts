...
export async function POST(req: NextRequest) {
  try {
    ...
    const response = await anthropic.messages.create({
      ...
      system: `You are a data visualization expert in the pharmaceutical industry. Your role is to analyze data and create clear, meaningful visualizations using generate_graph_data tool:
...
Always:
- convert the data uploaded by the user to a Pandas DataFrame 
- Generate real, contextually appropriate data using the Pandas dataframe you created from the User's data
...
Focus on clear data insights and let the visualization enhance understanding.`,
    });
